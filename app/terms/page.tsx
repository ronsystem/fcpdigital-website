    ...
    <div style={{ minHeight: '100vh', background: '#060606', color: '#fff', fontFamily: 'monospace' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px' }}>
        ...
        {[
          ...
          { title: 'SMS Messaging Terms', body: 'Program Name: FCP Digital Operational Notifications\n\nBy opting into SMS notifications through our consent form at https://ai.fcpdigital.net/sms-consent, you agree to receive automated text messages related to inbound call alerts, lead notifications, and call summaries generated by the FCP Digital AI receptionist system.\n\nMessage frequency varies depending on system activity on your account. Message and data rates may apply depending on your mobile carrier and plan.\n\nYou may cancel SMS notifications at any time by replying STOP. After texting STOP you will receive one final confirmation message. No further messages will be sent unless you re-opt in.\n\nFor assistance, reply HELP or contact us at services@fcpdigital.net or +1 313 327 3170.\n\nCarriers are not liable for delayed or undelivered messages.' },
