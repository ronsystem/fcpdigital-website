  ...
  return (
    <div style={{ minHeight: '100vh', background: '#060606', color: '#fff', fontFamily: 'monospace' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <h1 style={{ color: '#fff', fontSize: 28, fontWeight: 700, marginBottom: 8 }}>Terms of Service</h1>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ color: '#555', fontSize: 12, lineHeight: 1.9 }}>
            ...
            <p style={{ margin: '0 0 12px 0' }}><strong style={{ color: '#999' }}>5. Message & Data Rates:</strong> Message and data rates may apply for messages sent to you from us and to us from you. Message frequency varies based on your service usage and account activity. For questions about your text plan or data plan, contact your wireless provider.</p>
            <p style={{ margin: '0 0 12px 0' }}><strong style={{ color: '#999' }}>6. Supported Carriers:</strong> Our SMS program works with all major U.S. wireless carriers, including AT&T, T-Mobile, Verizon, Sprint, and most regional carriers.</p>
            <p style={{ margin: '0 0 12px 0' }}><strong style={{ color: '#999' }}>7. Age Restriction:</strong> You must be 18 years or older to participate in our SMS program.</p>
            <p style={{ margin: '0 0 12px 0' }}><strong style={{ color: '#999' }}>8. Privacy Policy:</strong> For privacy-related inquiries, please refer to our <a href="/privacy" style={{ color: '#dc2626', textDecoration: 'underline' }}>Privacy Policy</a>.</p>
            <p style={{ margin: '0 0 0 0' }}>We comply with all applicable laws and regulations, including the Telephone Consumer Protection Act (TCPA) and CTIA guidelines, regarding the use of SMS communications.</p>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <h2 style={{ color: '#fff', fontSize: 15, fontWeight: 700, marginBottom: 12 }}>Registration & Passwords</h2>
          <p style={{ color: '#555', fontSize: 12, lineHeight: 1.9, margin: 0 }}>To access certain features of the Site, you may be required to register and create an account. You agree to provide accurate, current, and complete information during the registration process. You are responsible for maintaining the confidentiality of your login credentials and for all activities conducted under your account.<br /><br />If you suspect unauthorized use of your account, notify us immediately at services@fcpdigital.net.</p>
        </div>

        <div style={{ marginBottom: 40 }}>
          <div style={{ color: '#dc2626', fontSize: 9, letterSpacing: '0.2em', marginBottom: 10 }}>07</div>
          <h2 style={{ color: '#fff', fontSize: 15, fontWeight: 700, marginBottom: 12 }}>Termination</h2>
          <p style={{ color: '#555', fontSize: 12, lineHeight: 1.9, margin: 0 }}>We reserve the right to terminate or suspend your access to the Site, without notice, if we determine that you have violated these Terms of Service or engaged in conduct that we deem inappropriate or unlawful.</p>
        </div>

        <div style={{ marginBottom: 40 }}>
          <div style={{ color: '#dc2626', fontSize: 9, letterSpacing: '0.2em', marginBottom: 10 }}>08</div>
          <h2 style={{ color: '#fff', fontSize: 15, fontWeight: 700, marginBottom: 12 }}>Governing Law</h2>
          <p style={{ color: '#555', fontSize: 12, lineHeight: 1.9, margin: 0 }}>These Terms of Service shall be governed by and construed in accordance with the laws of the State of Michigan. Any dispute arising under these Terms shall be resolved exclusively through binding arbitration in that jurisdiction.</p>
        </div>

        <div style={{ marginBottom: 40 }}>
          <div style={{ color: '#dc2626', fontSize: 9, letterSpacing: '0.2em', marginBottom: 10 }}>09</div>
          <h2 style={{ color: '#fff', fontSize: 15, fontWeight: 700, marginBottom: 12 }}>Changes to Terms of Service</h2>
          <p style={{ color: '#555', fontSize: 12, lineHeight: 1.9, margin: 0 }}>We may update these Terms of Service from time to time. The latest version will always be available on our website with the effective date.</p>
        </div>
