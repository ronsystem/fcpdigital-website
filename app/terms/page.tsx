  ...
  return (
    <div style={{ minHeight: '100vh', background: '#060606', color: '#fff', fontFamily: 'monospace' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px' }}>
        ...
        {[
          { title: 'Acceptance of Terms', body: 'By accessing or using FCP Digital services, you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services. We reserve the right to update these terms at any time with notice to you.', isHtml: false },
          { title: 'Description of Service', body: 'FCP Digital provides AI-powered telephone answering and call management services for service businesses. Our service includes call answering, message taking, appointment scheduling assistance, and call transcription delivered through an automated AI system.', isHtml: false },
          { title: 'SMS Messaging Terms', body: 'Program Name: FCP Digital Operational Notifications<br /><br />By opting into SMS notifications through our consent form at https://ai.fcpdigital.net/sms-consent, you agree to receive automated text messages related to inbound call alerts, lead notifications, and call summaries generated by the FCP Digital AI receptionist system.<br /><br />Message frequency varies depending on system activity on your account. Message and data rates may apply depending on your mobile carrier and plan.<br /><br />You may cancel SMS notifications at any time by replying <strong>STOP</strong>. After texting <strong>STOP</strong> you will receive one final confirmation message. No further messages will be sent unless you re-opt in.<br /><br />For assistance, reply <strong>HELP</strong> or contact us at services@fcpdigital.net or +1 313 327 3170.<br /><br />Carriers are not liable for delayed or undelivered messages.', isHtml: true },
          ...
          <div key={i} style={{ marginBottom: 40 }}>
            ...
            {s.isHtml ? (
              <p style={{ color: '#555', fontSize: 12, lineHeight: 1.9, margin: 0 }} dangerouslySetInnerHTML={{ __html: s.body }} />
            ) : (
